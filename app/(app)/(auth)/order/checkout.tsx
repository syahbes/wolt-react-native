...
const Page = () => {
  ...
  const mapStyle = useAnimatedStyle(() => {
    const scale = interpolate(scrollOffset.value, [-100, 0, 200], [1.3, 1, 0.9], Extrapolation.CLAMP);
      ...
      >
        <View style={styles.contentContainer}>
          ...
          <View style={styles.section}>
            ...
            <TouchableOpacity style={styles.radioRow} onPress={() => setDeliveryTime('standard')} disabled>
              <View style={styles.radioLeft}>
                <View style={styles.radioCircle}>{deliveryTime === 'standard' && <View style={styles.radioSelected} />}</View>
                <View>
                  <Text style={[styles.radioLabel, styles.disabledText]}>Standard</Text>
                  <Text style={[styles.radioSubtext, styles.disabledText]}>Currently unavailable</Text>
                </View>
              </View>
            </TouchableOpacity>
            ...
            <Link href="/order/schedule" asChild>
              <TouchableOpacity style={styles.radioRow} onPress={() => setDeliveryTime('schedule')}>
                <View style={styles.radioLeft}>
                  <View style={styles.radioCircle}>{deliveryTime === 'schedule' && <View style={styles.radioSelected} />}</View>
                  <View>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.tipDescription}>100% of your tip goes to your courier. It's an easy way to say thanks for great service.</Text>
